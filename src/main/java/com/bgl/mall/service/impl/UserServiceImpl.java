...
import com.bgl.mall.common.TokenCache;
import com.bgl.mall.dao.UserMapper;
import com.bgl.mall.pojo.User;
import com.bgl.mall.service.IUserService;
import com.bgl.mall.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> register(User user) {
        ServerResponse validResp = this.checkValid(user.getUsername(), Constant.USERNAME);
        if (!validResp.isSuccess()) {
            return validResp;
        }
        validResp = this.checkValid(user.getEmail(), Constant.EMAIL);
        if (!validResp.isSuccess()) {
            return validResp;
        }
    ...
    public ServerResponse<String> selectQuestion(String username) {
        ServerResponse validResp = this.checkValid(username, Constant.USERNAME);
        if (validResp.isSuccess()) {
